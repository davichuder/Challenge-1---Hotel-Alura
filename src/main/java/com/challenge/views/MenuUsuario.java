...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		lblNewLabel_2.setIcon(new ImageIcon(MenuUsuario.class.getResource("/img/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/img/reservado.png")));
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/img/pessoas.png")));
		...
		btnModificarValor.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnModificarValor.setBackground(new Color(118, 187, 223));
			}

			@Override
			public void mouseExited(MouseEvent e) {
				btnModificarValor.setBackground(new Color(12, 138, 199));
			}

			@Override
			public void mouseClicked(MouseEvent e) {
				ValorInput valorInput = new ValorInput();
				valorInput.setVisible(true);
				dispose();
			}
		});
		btnModificarValor.setBounds(0, 369, 257, 56);
		btnModificarValor.setBackground(new Color(12, 138, 199));
		panelMenu.add(btnModificarValor);
		btnModificarValor.setLayout(null);

		JLabel labelModificarValor = new JLabel("Modificar valor");
		labelModificarValor.setIcon(new ImageIcon(MenuUsuario.class.getResource("/img/editar-texto.png")));
		labelModificarValor.setForeground(SystemColor.text);
		labelModificarValor.setBounds(25, 11, 205, 34);
