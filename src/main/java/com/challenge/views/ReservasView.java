...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/img/Ha-100px.png")));

		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/img/reservas-img-3.png")));
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				if (ReservasView.txtFechaEntrada == null || ReservasView.txtFechaEntrada.getDate() == null ||
						ReservasView.txtFechaSalida == null || ReservasView.txtFechaSalida.getDate() == null) {
					return;
				}
				VariableController variableController = new VariableController();
				Float valorBase = variableController.findById("valor").getValorNumerico();
				...
				Long dias = ChronoUnit.DAYS.between(localDateEntrada, localDateSalida);
				Float valor = valorBase * dias;
				ReservasView.txtValor.setText(valor.toString());
			}
		});
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					Calendar caledarioEntrada = ReservasView.txtFechaEntrada.getCalendar();
					Calendar caledarioSalida = ReservasView.txtFechaSalida.getCalendar();
					if (caledarioEntrada.get(Calendar.YEAR) == caledarioSalida.get(Calendar.YEAR) &&
							caledarioEntrada.get(Calendar.DAY_OF_YEAR) == caledarioSalida.get(Calendar.DAY_OF_YEAR)) {
						JOptionPane.showMessageDialog(null, "No se puede entrar y salir el mismo dia.");
					} else if (caledarioEntrada.get(Calendar.YEAR) > caledarioSalida.get(Calendar.YEAR) ||
							(caledarioEntrada.get(Calendar.YEAR) == caledarioSalida.get(Calendar.YEAR)
						...
						registro.cargarReserva(reserva);
	...
	private void guardarReserva() {
		...
		Float valor = Float.parseFloat(ReservasView.txtValor.getText());
