...
public class Exito extends JDialog {
	 ...
	 */
	public Exito() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Exito.class.getResource("/img/aH-40px.png")));
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Exito.class.getResource("/img/Ha-100px.png")));
